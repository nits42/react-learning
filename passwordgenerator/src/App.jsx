...
function App() {
  ...
  }, [length, numberAllowed, specialCharacterAllowed, handleGeneratePassword])
      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          <button
            ...
            className='outline-none bg-blue-700 hover:bg-orange-600 text-white px-3 py-0.5 shrink-0'>
              copy
          </button>
        </div>
        <div className='flex text-sm gap-x-2'>
          <div className='flex items-center gap-x-1'>
            <input
              ...
              max={100}
              value={length}
              className='cursor-pointer accent-blue-500 hover:accent-orange-500'
